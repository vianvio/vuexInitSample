<template>
	<div class='login-holder'>
		...
		<div class='login-input-holder position-relative'>
			...
			<input type='text' class='login-input form-control' v-model='loginObj.username' placeholder='GUID' @keyup.13='login' />
		</div>
		<div class='login-input-holder position-relative'>
...
<script>
import { loginAction, setLoginFlag } from '../../vuex/action.js'
